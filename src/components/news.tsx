...
const News = () => {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                const response = await fetch('https://circl-backend-production.up.railway.app/news')
    ...
    return (
        <View style={styles.wrapper}>
            ...
            <View style={styles.header}>
                <Text style={styles.headerLabel}>ÚLTIMAS NOTICIAS</Text>
            ...
            >
                ...
                {/* Articles */}
                {!loading && articles.map((article: any, index: number) => (
